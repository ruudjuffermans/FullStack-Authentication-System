...
const config = {
    ...
    MAIL_SMTP_HOST: defaults("MAIL_SMTP_HOST", "localhost"),

    MAIL_PORT: defaults("MAIL_PORT", 2500),

    MAIL_SECURE: defaults("MAIL_SECURE", false),

    MAIL_SENDER: defaults("MAIL_SENDER", "example@example.com"),
